...
#ifndef MODBUS_RS485_LIBRARY_SRC_MODBUSRTU_H_
#define MODBUS_RS485_LIBRARY_SRC_MODBUSRTU_H_
...
private:
  ...
  /*
  * Modbus debugging option on/off
  */
  boolean MODBUS_DEBUG_ON = false;
...
public:
  bool validate_ans = false, pollOK = false;
...
#endif // MODBUS_RS485_LIBRARY_SRC_MODBUSRTU_H_
