...
// List of PSD profile param tags
enum CellularPSDProfileParamTag : uint8_t {
	CELL_PSD_PARAM_TAG_PROTOCOL_TYPE = 0,
	CELL_PSD_PARAM_TAG_APN = 1,
	CELL_PSD_PARAM_TAG_USERNAME = 2,
	CELL_PSD_PARAM_TAG_PASSWORD = 3, // Can set, but not read, this one.
	CELL_PSD_PARAM_TAG_ALL = 99,
};
...
public:
	...
	/**
	 * Returns a string, we will see the value
	 */
	String getPSDProfile(CellularPSDProfileParamTag paramTag = CELL_PSD_PARAM_TAG_ALL) const;
